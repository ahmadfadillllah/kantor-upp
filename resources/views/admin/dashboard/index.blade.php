                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                <p class="mb-0 text-muted font-13">
                                    <i class="mdi mdi-album mr-2 text-warning"></i>New Leads
                                </p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0 text-muted font-13">
                                    <i class="mdi mdi-album mr-2 text-danger"></i>New Leads Target
                                </p>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="border-top-0">
                                            <div class="media">
                                                <img src="{{ asset('admin/mannatthemes.com/zoogler/horizontal') }}/assets/images/users/avatar-2.jpg"
                                                    alt="" class="thumb-md rounded-circle" />
                                                <div class="media-body ml-2">
                                                    <p class="mb-0">
                                                        Roy Saunders
                                                        <span class="badge badge-soft-danger">USA</span>
                                                    </p>
                                                    <span class="font-12 text-muted">CEO of
                                                        facebook</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="border-top-0 text-right">
                                            <a href="#" class="btn btn-light btn-sm"><i
                                                    class="far fa-comments mr-2 text-success"></i>Chat</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <img src="{{ asset('admin/mannatthemes.com/zoogler/horizontal') }}/assets/images/users/avatar-3.jpg"
                                                    alt="" class="thumb-md rounded-circle" />
                                                <div class="media-body ml-2">
                                                    <p class="mb-0">
                                                        Tiger Nixon
                                                        <span class="badge badge-soft-info">UK</span>
                                                    </p>
                                                    <span class="font-12 text-muted">CEO of
                                                        WhatsApp</span>
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <img src="{{ asset('admin/mannatthemes.com/zoogler/horizontal') }}/assets/images/users/avatar-4.jpg"
                                                    alt="" class="thumb-md rounded-circle" />
                                                <div class="media-body ml-2">
                                                    <p class="mb-0">
                                                        Ashton Cox
                                                        <span class="badge badge-soft-pink">USA</span>
                                                    </p>
                                                    <span class="font-12 text-muted">founder of
                                                        Google</span>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <img src="{{ asset('admin/mannatthemes.com/zoogler/horizontal') }}/assets/images/users/avatar-5.jpg"
                                                    alt="" class="thumb-md rounded-circle" />
                                                <div class="media-body ml-2">
                                                    <p class="mb-0">
                                                        Cedric Kelly
                                                        <span class="badge badge-soft-purple">Canada</span>
                                                    </p>
                                                    <span class="font-12 text-muted">CEO of
                                                        Paypal</span>
                                                </div>
                                        ...
                                        <td class="">
                                            <div class="media">
                                                ...
                                                <div class="media-body ml-2">
                                                    <p class="mb-0">
                                                        Garry Pearson
                                                        <span class="badge badge-soft-info">India</span>
                                                    </p>
                                                    <span class="font-12 text-muted">CEO of
                                                        facebook</span>
                                                </div>
                                        ...
                                        <td>
                                            <div class="media">
                                                ...
                                                <div class="media-body ml-2">
                                                    <p class="mb-0">
                                                        Ashton Cox
                                                        <span class="badge badge-soft-pink">Africa</span>
                                                    </p>
                                                    <span class="font-12 text-muted">founder of
                                                        Google</span>
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <img src="{{ asset('admin/mannatthemes.com/zoogler/horizontal') }}/assets/images/users/avatar-1.jpg"
                                                    alt="" class="thumb-md rounded-circle" />
                                                <div class="media-body ml-2">
                                                    <p class="mb-0">
                                                        Roy Saunders
                                                        <span class="badge badge-soft-success">USA</span>
                                                    </p>
                                                    <span class="font-12 text-muted">Manager of
                                                        Bank</span>
                                                </div>
                                            </div>
                                        </td>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="font-14 text-muted mb-3">
                            ...
                            $ 1500 when an unknown printer took a
                            galley.
                        </p>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-sm-flex align-self-center">
                            <img src="{{ asset('admin/mannatthemes.com/zoogler/horizontal') }}/assets/images/widgets/code.svg"
                                alt="" class="" height="100" />
                            <div class="media-body ml-3">
                                <h6 class="mt-0">Code Confirmed</h6>
                                <p class="text-muted font-13">
                                    Contrary to popular belief,
                                    generators on Lorem Ipsum is not
                                    simply random text.
                                </p>
                            ...
                            <div class="entry">
                                ...
                                <div class="body">
                                    <p>
                                        ...
                                        available.....<a href="#" class="text-primary">
                                            Read More</a>
                                    </p>
                                </div>
                            </div>
                            <div class="entry">
                                ...
                                <div class="body">
                                    <p>
                                        ...
                                        on the predefined chunks as
                                        necessary.....<a href="#" class="text-primary">
                                            Read More</a>
                                    </p>
                                </div>
                            </div>
                            <div class="entry">
                                ...
                                <div class="body">
                                    <p>
                                        ...
                                        text.....<a href="#" class="text-primary">
                                            Read More</a>
                                    </p>
                                </div>
                            </div>
                            <div class="entry">
                                ...
                                <div class="body">
                                    <p class="pb-1">
                                        ...
                                        and web page editors now.....<a href="#" class="text-primary">
                                            Read More</a>
                                    </p>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>$15,000</td>
                                        <td>
                                            <span class="badge badge-boxed badge-soft-warning">panding</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>$35,000</td>
                                        <td>
                                            <span class="badge badge-boxed badge-soft-primary">Success</span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>$70,000</td>
                                        <td>
                                            <span class="badge badge-boxed badge-soft-warning">Success</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Product Devlopment</td>
                                        ...
                                        <td>$15,000</td>
                                        <td>
                                            <span class="badge badge-boxed badge-soft-primary">panding</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>New Office Building</td>
                                        <td>
                                            <img src="{{ asset('admin/mannatthemes.com/zoogler/horizontal') }}/assets/images/users/avatar-6.jpg"
                                                alt="" class="thumb-sm rounded-circle mr-2" />
                                            Frank M. Lyons
                                        </td>
                                        <td>Paypal</td>
                        ...
                        <div class="pt-3 border-top text-right">
                            <a href="#" class="text-primary">View all
